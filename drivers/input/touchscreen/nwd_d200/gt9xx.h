...
#define GTP_AUTO_UPDATE       0///1///1    // auto update fw by .bin file as default
...
#define GTP_COMPATIBLE_MODE  1 /// 0    // compatible with GT9XXF
...
///#include "../haobaoshou.h"
///#include "../hao.h"
/***    #define CTP_CFG_GROUP1{\
}
*/
///#include "KDT-5499-GT911_Config_20141106_181257.cfg"

///#include  "../last2.h"
 ///#include "GT910_Config_20130722_KDT4505_1024X600_rising.cfg"
#define CTP_CFG_GROUP1 {\
    } 
/***
...
#include "KDT-5499_GT911_V70_20141112.cfg"  ///jiechang ,8inch ,d200
...
#include "BR10082R-070-GT911_Config.cfg"  /***D200 911,7 inch ,xiongdi*/  
...
#define GTP_GPIO_OUTPUT(pin,level)     do{ gpio_direction_output(pin,level); gpio_set_value(pin,level); }  while(0)    /***wj add set_value*/
...
/****/
#define KEY_SELF_MENU KEY_F1
#define KEY_VOLUMEUP_NWD 		248
#define KEY_VOLUMEDOWN_NWD 		249
#define KEY_DISPLAYTOGGLE_NWD 		250
#define KEY_POWEROFF_NWD		251
#define KEY_F1_LONGPRESS_NWD		252
// STEP_4(optional): If keys are available and reported as keys, config your key info here                             
#if GTP_HAVE_TOUCH_KEY
    #define GTP_KEY_TAB  {KEY_F1, KEY_HOME, KEY_BACK,KEY_VOLUMEUP_NWD,KEY_VOLUMEDOWN_NWD,KEY_F1_LONGPRESS_NWD}
#endif
