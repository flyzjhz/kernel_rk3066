...
*********************************************************/
unsigned char I2cReadErrorTimes=0;
s32 gtp_i2c_read(struct i2c_client *client, u8 *buf, s32 len)
{
    ...
    while(retries < 5) //modify by lusterzhang
    {
        ret = i2c_transfer(client->adapter, msgs, 2);
        if(ret == 2)break;
        retries++;
    }
    if((retries >= 5)) //modify by lusterzhang 
    {
    #if GTP_SLIDE_WAKEUP
    ...
    #endif
        printk("I2C communication timeout, resetting chip time=%u...",I2cReadErrorTimes);
...
//    printk("goodix_ts_timer_handler...................\n");
    GTP_DEBUG_FUNC();
