...
extern unsigned char RunSystemTouchBuf[5];
/*******************************************************
Function:
...
static void gtp_touch_down_8198(struct goodix_ts_data* ts,s32 id,s32 x,s32 y,s32 w)
{
#if GTP_CHANGE_X2Y
    GTP_SWAP(x, y);
#endif
...
=======
    if(x>1 && x<50) ///GTP_HAVE_TOUCH_KEY
>>>>>>> d7567adafd491f7fd93576a85e57c6bf4f1673b8
    {  ///    #define GTP_KEY_TAB  {KEY_MENU,  KEY_BACK,KEY_HOME,KEY_VOLUMEDOWN_NWD,KEY_VOLUMEUP_NWD,KEY_DISPLAYTOGGLE_NWD}
        int key_value = 1; static timecnt=1;
                                                                                        static timecnthome=1;
/*      
...
static void goodix_ts_work_func(struct work_struct *work)
{
    ...
    if (pre_touch || touch_num)
    {
	    ...
	    else if(memcmp(RunSystemTouchBuf,"8198",3)==0)
            {
                gtp_touch_down_8198(ts, id, input_x, input_y, input_w);
            }
...
static s32 gtp_init_panel_596(struct goodix_ts_data *ts)   ///wr cfg
{
    s32 ret = -1;
...
static s32 gtp_init_panel_8198(struct goodix_ts_data *ts)   ///wr cfg
{
    s32 ret = -1;
    ...
    u8 cfg_info_group1[] = CTP_CFG_GROUP1_8198;
    u8 cfg_info_group2[] = CTP_CFG_GROUP2;
    u8 cfg_info_group3[] = CTP_CFG_GROUP3;
    u8 cfg_info_group4[] = CTP_CFG_GROUP4;
    u8 cfg_info_group5[] = CTP_CFG_GROUP5;
