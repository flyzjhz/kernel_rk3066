...
unsigned char wifisdioinitflag=0;
static void wifisdio_init_work(struct work_struct *work)
{
        msleep(15000);
//        platform_wifi_power_on();
        wifisdioinitflag=0x55;
        printk("wifisdiotimer_callback................\n");
        rtw_android_wifictrl_func_add();
}

static DECLARE_WORK(init_wifisdio_work,wifisdio_init_work);
...
//add by lusterzhang
//	schedule_work(&init_wifisdio_work);
//	rk29sdk_wifi_set_carddetect(1);
	rtw_android_wifictrl_func_add();
	goto exit;
...
int rockchip_wifi_init_module(void)
{
    ...
    printk("=======================================================\n");
    printk("Realtek 8723BS SDIO WiFi driver (Powered by Rockchip,Ver) init.\n" );
