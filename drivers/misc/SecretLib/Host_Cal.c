...
{
	// Local Variables
	UINT8 temporary[SHA204_MSG_SIZE_NONCE];
	UINT8 *p_temp;
 ...
 *         TheTempKey(if used) should be valid (temp_key.valid = 1) before executing this function.
 *
...
{
	// Local Variables
	UINT8 temporary[SHA204_MSG_SIZE_MAC];
	UINT8 i;
	UINT8 *p_temp;
...
{
	// Local Variables
	UINT8 temporary[SHA204_MSG_SIZE_HMAC_INNER];
	UINT8 i;
	UINT8 *p_temp;
...
{
	// Local Variables
	UINT8 temporary[SHA204_MSG_SIZE_GEN_DIG];
	UINT8 i;
	UINT8 *p_temp;
...
{
	// Local Variables
	UINT8 temporary[SHA204_MSG_SIZE_DERIVE_KEY];
	UINT8 i;
	UINT8 *p_temp;
...
{
	// Local Variables
	UINT8 temporary[SHA204_MSG_SIZE_DERIVE_KEY_MAC];
	UINT8 *p_temp;
...
{
	// Local Variables
	UINT8 temporary[SHA204_MSG_SIZE_ENCRYPT_MAC];
	UINT8 i;
	UINT8 *p_temp;
...
void sha204h_calculate_crc_chain(UINT8 length, UINT8 *data, UINT8 *crc)
{
	...
	crc_register = (((UINT16) crc[0]) & 0x00FF) | (((UINT16) crc[1]) << 8);
