...
#define RK29_SDMMC_WAIT_DTO_INTERNVAL   4500 ///4500  //The time interval from the CMD_DONE_INT to DTO_INTa
#define RK29_SDMMC_REMOVAL_DELAY       2000 ////60 ///100 /// 2000  //The time interval from the CD_INT to detect_timer react.A
