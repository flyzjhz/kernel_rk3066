...
#undef CONFIG_USE_SDMMC0_FOR_WIFI_DEVELOP_BOARD
...
struct rksdmmc_gpio_wifi_moudle  rk_platform_wifi_gpio = {
    .power_n = {
         ///   .io             = RK30SDK_WIFI_GPIO_POWER_N, A
...
int rk29sdk_wifi_power(int on)
{
        ...
        if (on){
                ...
                #if defined(CONFIG_SDMMC1_RK29) && !defined(CONFIG_SDMMC_RK29_OLD) && !defined(CONFIG_RTL8192CU) \
		&& !defined(CONFIG_RTL8188EU) && !defined(CONFIG_RTL8723AU)
