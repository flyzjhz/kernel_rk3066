...
#define sp2518_I2C_ADDR            0x60  /// 0xba/// 
...
/*** */
#define sp2518_PWRSEQ                       (SENSOR_PWRSEQ_SET(SENSOR_PWRSEQ_PWR,0)|\
                                        SENSOR_PWRSEQ_SET(SENSOR_PWRSEQ_HWRST,3)|\
                                        SENSOR_PWRSEQ_SET(SENSOR_PWRSEQ_PWRDN,2)|\
