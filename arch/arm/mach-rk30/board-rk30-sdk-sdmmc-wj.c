...
#define RK29SDK_SD_CARD_DETECT_N                INVALID_GPIO ///WJ ADD
//
...
//
    ...
    #if defined(CONFIG_RTL8192CU) || defined(CONFIG_RTL8188EU) || defined(CONFIG_RTL8723AU)||defined(CONFIG_RTL8723BU) || defined(CONFIG_RTL8192DU)
        #define RK30SDK_WIFI_GPIO_POWER_N               INVALID_GPIO///WJDEL            
        ...
        #elif defined(CONFIG_RTL8192CU) || defined(CONFIG_RTL8188EU)  || defined(CONFIG_RTL8723BU)|| defined(CONFIG_RTL8723AU) \
    ...
    #if defined(CONFIG_RKWIFI) || defined(CONFIG_RTL8192CU) || defined(CONFIG_RTL8188EU) ||defined(CONFIG_RTL8723BU) || defined(CONFIG_RTL8723AU) \
    ...
    //power
    #define RK30SDK_WIFI_GPIO_POWER_N               INVALID_GPIO///WJDEL //INVALID_GPIO///WJDEL       // huweiguo          
    #define RK30SDK_WIFI_GPIO_POWER_ENABLE_VALUE    GPIO_HIGH                   
    //reset
    ...
    #define RK30SDK_WIFI_GPIO_RESET_ENABLE_VALUE    GPIO_HIGH    
            ...
            #define USE_SDMMC_CONTROLLER_FOR_WIFI 1
                ...
                //BGF_INT_B
                #define RK30SDK_WIFI_GPIO_BGF_INT_B                 INVALID_GPIO///WJDEL
...
EXPORT_SYMBOL(rk29sdk_wifi_combo_get_GPS_SYNC_gpio);
    ...
    static struct mtk_wmt_platform_data mtk_wmt_pdata = {
        ...
        .rst = RK30SDK_WIFI_GPIO_RESET_N,//INVALID_GPIO///WJDEL, //MUST set to pin num in target system
