...
#define GPIO6B_GPIO6B0				0    /* wj add */ 
#define GPIO6B_GPIO6B3				0    /* wj add */  
#define GPIO6B_GPIO6B4				0   ///N311 LCD
#define GPIO6A_GPIO6A7				0   ///N311 LCD
#define GPIO6A_GPIO6A1				0   ///WIFI CS
...
#define GPIO6B0_TESTCLOCKOUT_NAME			"gpio6b0_testclockout_name"  /* wj add */
#define GPIO6B1_TESTCLOCKOUT_NAME			"gpio6b1_testclockout_name"  /* wj add */
#define GPIO6B2_TESTCLOCKOUT_NAME			"gpio6b2_testclockout_name"  /* wj add */
#define GPIO6B3_TESTCLOCKOUT_NAME			"gpio6b3_testclockout_name"  /* wj add */
#define GPIO6B4_TESTCLOCKOUT_NAME			"gpio6b4_testclockout_name"  /* wj add ,n311 lcd 7inch*/
#define GPIO6A7_TESTCLOCKOUT_NAME			"gpio6a7_testclockout_name" ///haobangshou cam pwr

#define GPIO6A0_TESTCLOCKOUT_NAME			"gpio6a0_testclockout_name" ///USB CHARGING,HAOBANGSHOU,INDOOR
#define GPIO6A1_TESTCLOCKOUT_NAME			"gpio6a1_testclockout_name" ///hW GPIO TST
#define GPIO6A5_TESTCLOCKOUT_NAME			"gpio6a5_testclockout_name" ///hW GPIO TST
#define GPIO6A6_TESTCLOCKOUT_NAME			"gpio6a6_testclockout_name" ///USB CHARGING,HAOBANGSHOU,INDOOR

#define GPIO6A7_TESTCLOCKOUT_NAME			"gpio6a7_testclockout_name" ///hW GPIO TST

#define GPIO6A2_TESTCLOCKOUT_NAME			"gpio6a2_testclockout_name" ///haobangshou cam pwr
